...
fcqs() {
  ...
  title=$(fcqs-cli |
    fzf --preview "fcqs-cli {}" \
      --bind "${FCQS_COPY_KEY}:execute-silent(fcqs-cli {} | ${FCQS_COPY_COMMAND}),${FCQS_OPEN_KEY}:execute-silent(fcqs-cli -u {} | xargs ${FCQS_OPEN_COMMAND}),${FCQS_EDIT_KEY}:execute-silent(fcqs-cli -l {} | ${FCQS_EDIT_COMMAND})+abort")
  fcqs-cli "$title"
  local command
